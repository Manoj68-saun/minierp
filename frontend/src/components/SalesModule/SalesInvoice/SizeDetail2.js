...
const SizeDetail = (props) => {
  ...
  //   const addRow = () => {
  //     const lastItem = formVal[formVal.length - 1];
  //     console.log(lastItem);
  //     // Check if the previous field is filled before adding a new row
  //     if (lastItem && (lastItem.name || lastItem.email)) {
  //       setFormVal([...formVal, { name: "", email: "" }]);
  //     }
  //   };
  ...
  //     // Validate the last item
  //     const isValidLastItem = formValidation([lastItem]);

  //     // Check if the previous field is filled and valid before adding a new row
  //     if (isValidLastItem && (lastItem.name || lastItem.email)) {
  //       setFormVal([...formVal, { name: "", email: "" }]);
  //     }
  //   };
  ...
  //     // Check if the previous field is filled and valid before adding a new row
  //     if (isValidLastItem && (lastItem.name || lastItem.email)) {
  //       setFormVal((prevFormVal) => [...prevFormVal, { name: "", email: "" }]);
  //     }
  //   };
