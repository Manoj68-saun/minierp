...
const PendingSalesRegister = (props) => {
    ...
    useEffect(() => {
        ...
        if(dFilter !== "all"){
            if(dFilter !== "fromTo" && dFilter !== "week")
            {
                ...
                setPendingRows(null)
                axios
                .get(employeeData.URL + '/api/v1/salesOrder/get-pending-orders/',{
...
console.log(endOfWeek1String);
            ...
            .then((response) => {
                ...
                if(fromDate !== "" && toDate !== ""){
                  ...
                  console.log(to)
                    axios
                    .get(employeeData.URL + '/api/v1/salesOrder/get-pending-orders/?from=' + from + "&to=" + to,{
                        withCredentials: true
                    })
                    .then((response) => {
        ...
        <>            
            <Row className = {classes['Row']}>
               {/* // {console.log(classes['Title'])} */}
                <Col md = {14}><p className = {classes['Title']}>Pending Sales Register</p></Col>
...
export default PendingSalesRegister