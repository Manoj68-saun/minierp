...
const AccountDetailsEdit = (props) => {
    ...
    const handleValueChanges = (changedValues, allValues) => {
        props.setData(data => {
            return({
                ...data,
                accountDetails: allValues.accountDetails
            })
        })
    }
    ...
    return(
        <Form layout="vertical" name="filter_form" onValuesChange = {handleValueChanges} autoComplete="off">
            <Form.List name="accountDetails" initialValue = {props.data}>
                {(fields, { add, remove }) => { 
                            ...
                            <Row key={key} gutter = {16}>
                                ...
                                <Col lg = {12} md = {24}>
                                    <Form.Item
                                        ...
                                        label = {<div style = {{padding: "0rem 0.5rem", fontSize: "0.6rem", fontWeight: "bold"}} className={classes['Label']}>ACCOUNT DETAILS</div>}
