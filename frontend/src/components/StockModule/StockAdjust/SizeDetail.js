...
const SizeDetail = (props) => {
  ...
  const handlechangee1 = async (changedValues, allValues, i) => {
    ...
    setSizef(sizef);
    const values = form.getFieldsValue(["stockDetail"]);
    ...
    // }
    values.stockDetail[i].Mode = false;
    values.stockDetail[i].size_code = null;
    values.stockDetail[i].uom_code = null;
    values.stockDetail[i].quality_code = null;
      ...
      axios
        ...
        .then((response) => {
          ...
          if (uomOptions.length === 1) {
            values.stockDetail[i].uom_code = uomOptions[0].value;
            form.setFieldsValue(values);
          }
  ...
  const handleKeyPress = (changedValues, allValues, i) => {
    console.log(i, "iiii");
    props.setData((data) => {
      const itemCode = data.stockDetail[i].item_code;
      const quantity = data.stockDetail[i].quantity;
      const qualityCode = data.stockDetail[i].quality_code;
      const sizeCode = data.stockDetail[i].size_code;
      const stockDate = data.stockHdr[0].stock_date;
  ...
  const handleValueChanges = (changedValues, allValues) => {
    props.setData((data) => {
      return {
        ...data,
        stockDetail: allValues.stockDetail,
  ...
  return props.editMode ? (
    ...
    >
      <div className="component-container">
        <Form.List name="stockDetail" initialValue={props.data}>
          {(fields, { add, remove }) => {
            return (
              <>
                      ...
                      >
                              ...
                              {props.ad.sn.rows.map((option) => {
                                return (
                                  <Option
                                    ...
                                    key={option[props.ad.sn.fields[0].name]}
                                    value={option[props.ad.sn.fields[0].name]}
                                  >
                                    {option[props.ad.sn.fields[1].name]}
                                  </Option>
                                );
                              })}
                            </Select>
                        ...
                        <td style={{ border: "1px solid white" }}>
                          ...
                          >
                            ...
                            >
                              {/* {props.editDode &&
                              props.responseDataArray[i].uom.fields[1].name ===
                                "get_uom"
