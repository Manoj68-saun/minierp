...
const RequisitionDetails = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(employeeData.URL + "/api/v1/dailyprod", {
              ...
              return {
                ...
                V: (
                  <Tooltip placement="bottom" title="View" color="#1777C4">
                    <Link
                      to={
                        "/stock/transaction/daily_prod-view/" + row["ssh_code"]
                      }
          ...
          let newDRows = rowvals.map((row, index) => {
            return {
              ...
              V: (
                <Tooltip placement="bottom" title="View" color="#1777C4">
                  <Link
                    to={"/stock/transaction/daily_prod-view/" + row["ssh_code"]}
                    style={{ color: "#1777C4", fontWeight: "bolder" }}
                  >
                    <EditOutlined
                      style={{
          ...
          let newDRows = newrows.map((row, index) => {
            return {
              ...
              V: (
                <Tooltip placement="bottom" title="View" color="#1777C4">
                  <Link
                    to={"/stock/transaction/daily-prod-view" + row["ssh_code"]}
                    style={{ color: "#1777C4", fontWeight: "bolder" }}
                  >
                    <EditOutlined
                      style={{
  ...
  return (
    <>
      <Row className={classes["Row"]}>
        <Col md={14}>
          <p className={classes["Title"]}>Daily Production Details</p>
        </Col>
      ...
      <Row className={classes["Row"]}>
        ...
        <Col className={classes["Col"]} lg={5} md={7}>
          <Link to="/stock/transaction/daily-prod-new">
            <button
              style={{
